...
public class ButtonDemoToggleObjectOnOff : ButtonToggleBase 
{
  ...
  {
		TurnsOnGraphics ();
		obj1.gameObject.GetComponent<Renderer>().enabled = true;
		obj2.gameObject.GetComponent<Renderer>().enabled = true;
		obj3.gameObject.GetComponent<Renderer>().enabled = true;
		obj4.gameObject.GetComponent<Renderer>().enabled = true;
  ...
  {
    TurnsOffGraphics();
		obj1.gameObject.GetComponent<Renderer>().enabled = false;
		obj2.gameObject.GetComponent<Renderer>().enabled = false;
		obj3.gameObject.GetComponent<Renderer>().enabled = false;
		obj4.gameObject.GetComponent<Renderer>().enabled = false;
	}
