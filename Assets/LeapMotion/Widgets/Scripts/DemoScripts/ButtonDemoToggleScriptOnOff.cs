...
public class ButtonDemoToggleScriptOnOff : ButtonToggleBase 
{
  ...
  {
		TurnsOnGraphics ();
		//mybuttons.gameObject.GetComponent<"Orbit1"> ().enabled = true;
		//mycamera.gameObject.GetComponent<"Orbit1"> ().enabled = true;
  ...
  {
    TurnsOffGraphics();
		//mybuttons.gameObject.GetComponent<"Orbit1"> ().enabled = false;
