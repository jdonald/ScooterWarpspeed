...
public class ButtonDemoToggleSpinOnOff : ButtonToggleBase 
{
  ...
  {
		TurnsOnGraphics ();
		obj1.gameObject.GetComponent<Orbit1>().enabled = true;
		obj2.gameObject.GetComponent<Orbit1>().enabled = true;
  ...
  {
    TurnsOffGraphics();
		obj1.gameObject.GetComponent<Orbit1>().enabled = false;
		obj2.gameObject.GetComponent<Orbit1>().enabled = false;
